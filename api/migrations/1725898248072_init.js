...
exports.up = (pgm) => {
  ...
  INSERT INTO listing (listing_title, listing_desc, images, uploaded_by, is_available, rented_on, location, city, state, accommodation_type)
  VALUES
  ('Cozy Apartment', 'A cozy 2-bedroom apartment with a great city view.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Downtown', 'New York', 'NY', 0),
  ('Spacious Villa', 'Luxurious villa with a private pool and garden.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Palm Beach', 'Miami', 'FL', 1),
  ('Modern Studio', 'A modern studio apartment perfect for young professionals.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Midtown', 'Los Angeles', 'CA', 2),
  ('Beachside Cottage', 'Charming beachside cottage, steps from the ocean.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Oceanfront', 'San Diego', 'CA', 0),
  ('Suburban House', '4-bedroom house in a peaceful suburban neighborhood.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Greenwood', 'Seattle', 'WA', 1),
  ('Urban Condo', 'Modern condo in the heart of the city.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, false, '2024-09-01 10:30:00', 'Central Park', 'Chicago', 'IL', 2),
  ('Mountain Cabin', 'Cabin with stunning mountain views and hiking trails.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, false, '2024-08-15 14:00:00', 'Pine Hills', 'Denver', 'CO', 0),
  ('Stylish Apartment', 'A stylish apartment in the city center.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'City Center', 'New York', 'NY', 1),
  ('Luxury Villa', 'A luxurious villa with stunning views.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Uptown', 'Los Angeles', 'CA', 2),
  ('Modern Condo', 'A modern condo with all amenities.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Downtown', 'Miami', 'FL', 0),
  ('Charming Studio', 'A charming studio apartment.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Soho', 'New York', 'NY', 1),
  ('Beach House', 'A cozy beach house just steps from the ocean.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Ocean Drive', 'Miami', 'FL', 2),
  ('Suburban Home', 'A family-friendly home in the suburbs.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Greenwood', 'Seattle', 'WA', 0),
  ('Penthouse Suite', 'Luxurious penthouse with panoramic views.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Beverly Hills', 'Los Angeles', 'CA', 1),
  ('Cozy Cottage', 'A charming cottage in the woods.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Mountain View', 'Denver', 'CO', 2),
  ('Urban Loft', 'An urban loft with an industrial vibe.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Central Park', 'Chicago', 'IL', 0),
  ('Riverside Bungalow', 'A beautiful bungalow by the river.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Riverside', 'Austin', 'TX', 1),
  ('Country Farmhouse', 'A rustic farmhouse in the countryside.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Farmington', 'Nashville', 'TN', 2),
  ('Downtown Studio', 'A small studio in the heart of downtown.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Downtown', 'San Francisco', 'CA', 0),
  ('Loft Apartment', 'Spacious loft apartment with modern design.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'District 9', 'Miami', 'FL', 1),
  ('Historic Mansion', 'A beautifully restored historic mansion.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Historic District', 'New Orleans', 'LA', 2),
  ('Garden Apartment', 'An apartment with a lovely garden.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Green Valley', 'Phoenix', 'AZ', 0),
  ('Skylight Apartment', 'An apartment with skylights and natural light.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Highland Park', 'Dallas', 'TX', 1),
  ('Contemporary House', 'A contemporary house with unique design.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'North Shore', 'Chicago', 'IL', 2),
  ('Artisan Loft', 'A creative loft space for artists.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Arts District', 'Los Angeles', 'CA', 0),
  ('Luxury Condo', 'Luxury condo with modern amenities.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Sunny Isles', 'Miami', 'FL', 1),
  ('Seaside Villa', 'A beautiful villa by the sea.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'Oceanfront', 'Santa Monica', 'CA', 2),
  ('Furnished Apartment', 'A fully furnished apartment ready to move in.', '["/assets/upload/images/image1.jpg", "/assets/upload/images/image2.jpg"]', 1, true, NULL, 'West End', 'Austin', 'TX', 0);
