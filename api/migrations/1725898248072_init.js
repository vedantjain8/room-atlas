...
exports.up = (pgm) => {
  ...
  VALUES
  ('Cozy Apartment', 'A cozy 2-bedroom apartment with a great city view.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Downtown', 'New York', 'NY', 0),
  ('Spacious Villa', 'Luxurious villa with a private pool and garden.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Palm Beach', 'Miami', 'FL', 1),
  ('Modern Studio', 'A modern studio apartment perfect for young professionals.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Midtown', 'Los Angeles', 'CA', 2),
  ('Beachside Cottage', 'Charming beachside cottage, steps from the ocean.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Oceanfront', 'San Diego', 'CA', 0),
  ('Suburban House', '4-bedroom house in a peaceful suburban neighborhood.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Greenwood', 'Seattle', 'WA', 1),
  ('Urban Condo', 'Modern condo in the heart of the city.', '["image1.jpg", "image2.jpg"]', 1, false, '2024-09-01 10:30:00', 'Central Park', 'Chicago', 'IL', 2),
  ('Mountain Cabin', 'Cabin with stunning mountain views and hiking trails.', '["image1.jpg", "image2.jpg"]', 1, false, '2024-08-15 14:00:00', 'Pine Hills', 'Denver', 'CO', 0),
  ('Stylish Apartment', 'A stylish apartment in the city center.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'City Center', 'New York', 'NY', 1),
  ('Luxury Villa', 'A luxurious villa with stunning views.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Uptown', 'Los Angeles', 'CA', 2),
  ('Modern Condo', 'A modern condo with all amenities.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Downtown', 'Miami', 'FL', 0),
  ('Charming Studio', 'A charming studio apartment.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Soho', 'New York', 'NY', 1),
  ('Beach House', 'A cozy beach house just steps from the ocean.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Ocean Drive', 'Miami', 'FL', 2),
  ('Suburban Home', 'A family-friendly home in the suburbs.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Greenwood', 'Seattle', 'WA', 0),
  ('Penthouse Suite', 'Luxurious penthouse with panoramic views.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Beverly Hills', 'Los Angeles', 'CA', 1),
  ('Cozy Cottage', 'A charming cottage in the woods.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Mountain View', 'Denver', 'CO', 2),
  ('Urban Loft', 'An urban loft with an industrial vibe.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Central Park', 'Chicago', 'IL', 0),
  ('Riverside Bungalow', 'A beautiful bungalow by the river.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Riverside', 'Austin', 'TX', 1),
  ('Country Farmhouse', 'A rustic farmhouse in the countryside.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Farmington', 'Nashville', 'TN', 2),
  ('Downtown Studio', 'A small studio in the heart of downtown.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Downtown', 'San Francisco', 'CA', 0),
  ('Loft Apartment', 'Spacious loft apartment with modern design.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'District 9', 'Miami', 'FL', 1),
  ('Historic Mansion', 'A beautifully restored historic mansion.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Historic District', 'New Orleans', 'LA', 2),
  ('Garden Apartment', 'An apartment with a lovely garden.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Green Valley', 'Phoenix', 'AZ', 0),
  ('Skylight Apartment', 'An apartment with skylights and natural light.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Highland Park', 'Dallas', 'TX', 1),
  ('Contemporary House', 'A contemporary house with unique design.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'North Shore', 'Chicago', 'IL', 2),
  ('Artisan Loft', 'A creative loft space for artists.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Arts District', 'Los Angeles', 'CA', 0),
  ('Luxury Condo', 'Luxury condo with modern amenities.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Sunny Isles', 'Miami', 'FL', 1),
  ('Seaside Villa', 'A beautiful villa by the sea.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'Oceanfront', 'Santa Monica', 'CA', 2),
  ('Furnished Apartment', 'A fully furnished apartment ready to move in.', '["image1.jpg", "image2.jpg"]', 1, true, NULL, 'West End', 'Austin', 'TX', 0);
