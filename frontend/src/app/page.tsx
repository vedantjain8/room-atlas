  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Stay connected effortlessly! Our messaging system lets you
            communicate directly with property owners, brokers, or roommates.
            Send requests, chat securely, and clarify details to ensure a smooth
            rental experience.
          </p>
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            Schedule hassle-free appointments to visit your potential home! Book
            a time that works for you, meet the owner, and explore the space in
            person for complete peace of mind.
          </p>
          <p className="text-neutral-800 dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
            <span className="italic">Advanced Calendar</span> to add
            appointments directly linked to your Google Calendar
          </p>
          <div className="flex justify-center">
            <Image
              src={meet}
